 ...
 */
static const std::string pipeline_vs_2 = R"(
 ...
 */
static const std::string pipeline_fs_2 = R"(
...
bool ENG_API Eng::PipelineShadowMapping::init()
{
   ...
   // Build:
   reserved->vs.load(Eng::Shader::Type::vertex, pipeline_vs_2);
   reserved->fs.load(Eng::Shader::Type::fragment, pipeline_fs_2);   
